...
import numpy as np
mec = Mecanismo()
x_motor,y_motor,x_biela,x_intercept,y_intercept,modulo_motor_cir,modulo_biela_cir= mec.mec_Biela([0.127 , 0.508],np.deg2rad(225),0.127)
...
#mec.plot_mec_Biela(x_motor,y_motor,x_biela,0.127,90,x_intercept,y_intercept)
